    ...
    <section class="block block--dark">
      <div class="block-inner">
        ...
        <div class="resume-options-grid">
          <a href="resume-templates.html" class="resume-option-card reveal">
          ...
          <a href="resume-ai-tools.html" class="resume-option-card reveal reveal-delay-1">
            <span class="resume-option-icon">✨</span>
            <h3 class="resume-option-title">Improve your existing resume</h3>
            <p class="resume-option-desc">Use free AI to tailor your resume to a job posting, enhance bullet points, generate summaries, and get skill suggestions.</p>
            <span class="resume-option-cta">Use AI tools →</span>
          </a>
        </div>
      </div>
    </section>
